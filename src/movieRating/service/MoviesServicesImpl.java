...
public class MoviesServicesImpl implements MoviesService{
    ...
    final MoviesSearchServiceImpl moviesFilterService = new MoviesSearchServiceImpl();
    final MoviesValidationServicesImpl moviesValidationServices = new MoviesValidationServicesImpl();
    ...
    @Override
    public void searchMovies(Map<String, Movie> map) {
        System.out.println("Search\n1.Status\n2.Year\n3.Cast\n4.Movie Name\n5.Status And Year");
        int filter = sc.nextInt();
        switch (filter){
            case 1:moviesFilterService.statusSearch(map);
            break;
            case 2:moviesFilterService.yearSearch(map);
            break;
            case 3: moviesFilterService.castSearch(map);
            break;
            case 4:moviesFilterService.movieNameSearch(map);
            break;
            case 5:moviesFilterService.yearStatusSearch(map);
            break;
            default:break;
        }
    }
